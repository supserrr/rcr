...
# Jitsi Configuration (for video conferencing)
# Option 1: Free Jitsi (default - no setup required)
NEXT_PUBLIC_JITSI_DOMAIN=meet.jit.si

# Option 2: Jitsi as a Service (JaaS) via 8x8.vc
# NEXT_PUBLIC_JITSI_DOMAIN=8x8.vc
# NEXT_PUBLIC_JITSI_APP_ID=your_jitsi_app_id

# Option 3: Self-hosted Jitsi instance
...
- `NEXT_PUBLIC_JITSI_DOMAIN`: Jitsi domain
  - Default: `meet.jit.si` (free Jitsi - no setup required)
  - For JaaS: `8x8.vc` (requires app ID)
  - For self-hosted: your custom domain
- `NEXT_PUBLIC_JITSI_APP_ID`: Jitsi app ID (required only for JaaS deployments)
