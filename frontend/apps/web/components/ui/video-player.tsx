...
const VideoPlayer = React.forwardRef<HTMLVideoElement, VideoPlayerProps>(
  (
    { className, size, src, showControls = true, autoHide = true, ...props },
    ref
  ) => {
    ...
    React.useEffect(() => {
      ...
      return () => {
        ...
        video.removeEventListener("volumechange", handleVol);
        if (hideControlsTimeoutRef.current) clearTimeout(hideControlsTimeoutRef.current);
      };
    }, [autoHide, isPlaying]);
            ...
            >
              ...
              >
                {isPlaying ? (
                  ...
                  <Play className="w-6 h-6 transform -translate-x-[1px]" />
                )}
              </button>
            </div>
            <div
                  ...
                  <div className="flex-1 relative group/progress">
                    <input
                      ...
                      className="w-full h-1 bg-white/30 rounded-full appearance-none cursor-pointer
                        ...
                        [&::-ms-thumb]:w-4 [&::-ms-thumb]:h-4 [&::-ms-thumb]:rounded-full [&::-ms-thumb]:bg-white"
                      style={{
                    ...
                    <div className="flex items-center gap-2 group/volume">
                      ...
                      <div className="w-0 group-hover/volume:w-20 transition-all duration-200 overflow-hidden">
                        <input
                          ...
                          className="w-full h-1 bg-white/30 rounded-full appearance-none cursor-pointer [&::-webkit-slider-thumb]:appearance-none [&::-webkit-slider-thumb]:w-2 [&::-webkit-slider-thumb]:h-2 [&::-webkit-slider-thumb]:rounded-full [&::-webkit-slider-thumb]:bg-white [&::-webkit-slider-thumb]:cursor-pointer"
                          style={{
                            background: `linear-gradient(to right, #ffffff 0%, #ffffff ${
