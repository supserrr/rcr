...
const sampleTestimonials: Testimonial[] = [
  {
    avatarSrc: "https://images.unsplash.com/photo-1612349317150-e413f6a5b16d?w=150&h=150&fit=crop&crop=face",
    name: "Dr. Sarah Johnson",
    handle: "@drsarahjohnson",
    text: "Working with RCR has been incredibly rewarding. The platform makes it easy to connect with patients and provide meaningful support."
  },
  {
...
/**
 * Counselor Sign Up page component for Rwanda Cancer Relief
 */
export default function CounselorSignUpPage() {
  ...
  const handleGoogleSignUp = async () => {
    try {
      ...
      const redirectTo = `${window.location.origin}/auth/callback?next=${encodeURIComponent('/onboarding/counselor')}&role=${encodeURIComponent(role)}`;
          ...
          <div className="flex flex-col gap-6">
            <h1 className="animate-element animate-delay-100 text-4xl md:text-5xl font-semibold leading-tight">
              <span className="font-light text-foreground tracking-tighter">
                Join Our <span className="font-semibold text-primary">Counselor Network</span>
              </span>
            </h1>
            <p className="animate-element animate-delay-200 text-muted-foreground">
              Create your account and become part of a network dedicated to bringing comfort, understanding, and guidance to those affected by cancer.
            </p>
