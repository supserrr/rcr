...
A helper script is available at `apps/web/scripts/add-jitsi-keys.sh`:

```bash
cd apps/web
./scripts/add-jitsi-keys.sh
```

This script will:
1. Prompt for your App ID
2. Optionally read your private key from a file
3. Add all configuration to `.env.local`
...
- [Jitsi Setup Guide](./SETUP.md)
- [Production Deployment](../deployment/JITSI_PRODUCTION.md)
- [Jitsi Integration Overview](../JITSI_INTEGRATION.md)
