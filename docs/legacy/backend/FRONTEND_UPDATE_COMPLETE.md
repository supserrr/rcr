...
### Components
- `apps/web/app/dashboard/patient/chat/page.tsx` - Updated to use Realtime
- `apps/web/app/dashboard/counselor/chat/page.tsx` - Updated to use Realtime

### API Client
- `apps/web/lib/api/client.ts` - Updated to use Supabase Edge Functions

### Environment
- `apps/web/.env.local` - Cleaned up old variables
